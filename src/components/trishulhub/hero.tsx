    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2 lg:gap-8">
        ...
        >
          ...
          <motion.h1
            variants={heroItem}
            className="text-4xl font-bold leading-[1.08] tracking-[-0.03em] text-[#111111] sm:text-5xl md:text-6xl lg:text-[3.75rem]"
          >
          ...
          >
            ...
            <Link
              href="/services"
              className="inline-flex h-[52px] items-center justify-center rounded-full border border-[#e5e7eb] bg-white px-7 text-sm font-semibold text-[#111111] transition hover:border-[#111111]/30"
            >
              See our services
            </Link>
          </motion.div>
        ...
        {/* Right visual collage — Lawtrades-style floating cards + soft teal glow */}
        <motion.div
        ...
        >
          ...
          <div className="absolute inset-[18%] overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#e8f4f3] to-[#d4eae8] shadow-[0_24px_60px_rgba(117,180,177,0.25)]">
          ...
          {floatCards.map((c) => {
            ...
            return (
              <motion.div
                ...
                className="absolute flex items-center gap-2.5 rounded-2xl border border-[#e8e8e8] bg-white px-3.5 py-2.5 shadow-[0_12px_32px_rgba(0,0,0,0.08)]"
                style={{ top: c.top, left: c.left }}
              >
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#e8f4f3] text-[#75B4B1]">
                  <Icon size={15} />
                </span>
          ...
          <motion.div
            ...
            className="absolute bottom-[12%] right-[4%] rounded-2xl border border-[#e8e8e8] bg-white px-3.5 py-2.5 shadow-[0_12px_32px_rgba(0,0,0,0.08)]"
          >
            <p className="text-[11px] font-medium text-[#6b7280]">From</p>
            <p className="text-sm font-bold text-[#111111]">
              £400 <span className="font-medium text-[#75B4B1]">projects</span>
            </p>
          </motion.div>
        </motion.div>
      </div>
        ...
        <div className="mt-14 flex justify-center lg:mt-20">
          <div className="flex h-10 w-6 items-start justify-center rounded-full border border-[#e5e7eb] bg-white p-1.5">
            <motion.div
              ...
              className="h-2 w-1 rounded-full bg-[#75B4B1]"
            />
          </div>
        </div>
      </FadeIn>
