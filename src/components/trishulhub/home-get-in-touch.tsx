...
function NodeFace({ node }: { node: NodeSpec }) {
  return (
    <>
      ...
      />
      <div className="relative flex h-14 w-14 items-center justify-center rounded-full border border-white/[0.1] bg-white/[0.04] shadow-[0_12px_28px_-14px_rgba(0,0,0,0.85)] backdrop-blur-xl transition-transform duration-300 group-hover:scale-[1.06] md:h-16 md:w-16">
