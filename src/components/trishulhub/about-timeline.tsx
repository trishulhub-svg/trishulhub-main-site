    ...
    <section className="relative mt-4 sm:mt-8">
      <div className="mb-14 max-w-3xl">
        <div className="mb-5 inline-flex items-center gap-3">
          <span className="flex h-7 w-7 items-center justify-center rounded-lg border border-[#0d9488]/25 bg-[#e8f4f3] font-display text-[11px] font-medium text-[#0d9488]">
            01
          </span>
          <span className="inline-flex items-center gap-2 font-display text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">
            <CalendarRange className="h-3.5 w-3.5 text-[#0d9488]" />
            Our story
          </span>
        </div>
        <AnimatedHeading
      ...
      >
        ...
        <motion.div
          ...
          className="pointer-events-none absolute left-8 top-10 w-px bg-gradient-to-b from-[#0d9488] via-[#0d9488]/70 to-transparent sm:left-1/2 sm:-translate-x-1/2"
        />
        <div className="about-timeline-scan pointer-events-none absolute left-8 h-16 w-px -translate-x-1/2 bg-gradient-to-b from-transparent via-[#0d9488] to-transparent sm:left-1/2" />
            ...
            return (
              ...
              >
                <div className="absolute left-8 top-8 z-10 flex -translate-x-1/2 items-center justify-center sm:left-1/2 sm:top-1/2 sm:-translate-y-1/2">
                  <span className="flex h-11 w-11 items-center justify-center rounded-full border border-[#0d9488]/30 bg-white text-[#0d9488] shadow-sm">
                    <Icon size={18} />
                  </span>
                </div>
                ...
                >
                  <div className="relative overflow-hidden rounded-[18px] border border-border bg-white p-5 shadow-sm transition-colors hover:border-[#0d9488]/25">
                    <span
                      aria-hidden
                      className="pointer-events-none absolute -right-1 -top-2 select-none font-display text-6xl font-bold leading-none tracking-tight text-[#0d9488]/15 sm:text-7xl"
                    >
                      {m.year}
                    </span>
                    ...
                    <div className="relative z-10">
                      <div className="mb-2 flex flex-wrap items-center gap-2">
                        <span className="inline-flex items-center rounded-lg border border-[#0d9488]/25 bg-[#e8f4f3] px-2.5 py-1 font-display text-sm font-bold tracking-tight text-[#0d9488]">
                          {m.year}
                        </span>
                        <span className="inline-flex items-center gap-1.5 rounded-full border border-border bg-secondary px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                          <span className="h-1.5 w-1.5 animate-pulse rounded-lg bg-black" />
                          {m.status}
                        </span>
                      </div>
