...
export function LoadingScreen() {
  ...
  useEffect(() => {
    const kickoff = () => {
      setMounted(true)
      let raf = 0
      let finishTimer: ReturnTypeof<typeof setTimeout> | undefined
  ...
  return (
    <AnimatePresence>
      {!done && (
        <motion.div
          className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#0A0A0]"
          exit={{ opacity: 0 }}
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  background:
                    'conic-gradient(from 0deg, transparent 0deg, #00DEFF 90deg, transparent 180deg, #0088CC 270deg, transparent 360deg, #0088CC 270deg, transparent 360deg)',
                  filter: 'blur(14px)',
                }}
              />
              <img
            ...
            >
              ...
              >
                ...
                <span className="gradient-text">HUG</span>
              </span>
            </motion.div>
